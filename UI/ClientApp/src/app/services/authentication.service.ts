...
export class AuthenticationService {
  ...
  logout() {
    ...
    this.http.post<any>(`${this.appComponent.APIURL}/logout`, {}, { withCredentials: true }).subscribe();
    this.router.navigate(['/login']);
  }

  refreshToken() {
    return this.http.post<any>(`${this.appComponent.APIURL}/Auth/Verify`, {}, { withCredentials: true })
      .pipe(map((user) => {
        this.userSubject.next(user);
        this.startRefreshTokenTimer();
        return user;
